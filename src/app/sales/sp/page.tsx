...
function monthLink(year: number, month: number, storeIds: string[]) {
  ...
  return `/sales/sp?${q.toString()}`;
}

export default async function SalesSpPage({
  searchParams,
}: {
    ...
    <>
      ...
      <main style={{ padding: "1rem", maxWidth: 480, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "0.75rem" }}>
          ...
          <StoreFilterChips stores={stores} storeIds={storeIds} year={year} month={month} basePath="/sales/sp" />
        </div>

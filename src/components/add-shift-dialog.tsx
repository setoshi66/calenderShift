    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit} style={{ display: "grid", gap: "0.6rem", minWidth: 280 }}>
          <h3 style={{ margin: 0 }}>{date} のシフトを登録</h3>
          ...
          <div style={{ display: "flex", gap: "0.5rem" }}>
            <label style={{ flex: 1 }}>
              開始 *
              <input type="time" name="startTime" required defaultValue="18:00" style={{ width: "100%" }} />
            </label>
            <label style={{ flex: 1 }}>
              終了 *
              <input type="time" name="endTime" required defaultValue="23:00" style={{ width: "100%" }} />
            </label>
          </div>
          <label>
            状態
            <select name="status" defaultValue="CONFIRMED" style={{ width: "100%" }}>
